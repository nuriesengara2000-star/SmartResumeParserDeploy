...
Production-ready API для генерации структурированных данных из текста резюме с помощью LLM-модели **Qwen2.5-7B-Instruct**. Приложение принимает текст резюме и возвращает структурированный JSON с извлечёнными полями (ФИО, контакты, образование, опыт, навыки).
